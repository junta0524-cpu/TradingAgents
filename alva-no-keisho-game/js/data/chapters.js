// 章データ ― シナリオ資料集「アルヴァの継承」全16章(序章+第一〜十四章+終章)の進行定義。
...
Game.Data.Chapters = [
  {
    title: '序章 ― 竜帝討滅、そしてタルドームの選択',
    intro: [
      '竜帝の城が くずれ落ちる轟音を背に、アルヴァはレイラ姫を抱えてタルドームへ帰還した。',
      '国王「アルヴァよ、そなたに 王位と姫の手を授けよう」',
      'アルヴァ「……陛下、竜帝は滅びました。しかしこの目で見たのです。やつの軍勢は、なお大陸のすみずみに 散らばっています」',
  ...
  },
  {
    ...
    outro: ['丘陵の向こうに、新たな都を築くにふさわしい土地が見えた。ここが、のちのヴァルデリアとなる。'],
  },
  {
    title: '第二章 ― 蒼穹の塔の賢者',
    ...
    stages: [
      ...
      },
      {
        ...
        intro: [
          '塔の中でアルヴァはエルロードと合流した。エルロード「共に行きましょう」',
          'エルロード「各階に 燭台があります。すべてに 火が入らないかぎり、最上層の扉は 開きません」',
        ],
      },
    ],
    outro: ['封印の番人を退け、エルロードは「知の国」を興す決意を固めた。以後もアルヴァの一行として、共に歩むこととなる。'],
  ...
  },
  {
    ...
    outro: ['セレスティアは「西方の脅威はまだ終わっていない」と確信し、アルヴァの一行に加わった。'],
    onComplete: { recruit: 'celestia', gear: ['moon_bow'], gold: 200 },
  },
  {
    title: '第四章 ― 三者の道、それぞれの礎',
    intro: [
      'アルヴァ・エルロード・セレスティアは、それぞれの地で最初の困難を乗り越えた。',
      'アルヴァの剣・鎧・盾――アルヴァの遺産の扱いを巡って、三者の間で書簡が交わされる。',
      'この議論の決着は、盟約の日まで持ち越されることとなる。',
    ],
    stages: [{
      map: 'valderia_town', type: 'gate',
      goal: '城下の者と話し、築城の支度を ととのえる',
      require: { talk: ['valderia_leyla', 'valderia_smith', 'valderia_noble'] },
      blocked: 'まだ 話を通していない者が いる。',
    }],
    outro: ['ヴァルデリアの築城が、いよいよ本格的に始まる。'],
  },
  {
    title: '第五章 ― ヴァルデリア築城',
    intro: ['築城が進む中、周辺一帯を縄張りとする竜帝軍の残存幹部「牙のオーガ将軍ガロズ」が姿を現した。'],
    stages: [{
      ...
      afterClear: {
        ...
        options: [
          { label: '投降を 受け入れる', note: '赦しによる国造り', flag: 'galoz_spared',
            lines: [
              'アルヴァ「立て。お前の武は、これから 守るために使え」',
              'ガロズ「……なぜだ。俺は お前の民を 幾人も 殺めた」',
              'アルヴァ「だからこそだ。斬れば ひとり減る。赦せば ひとり増える」',
              'ガロズは 長く沈黙し、やがて 牙の棍棒を 地に置いた。',
            ] },
          { label: 'とどめを 刺す', note: '力による国造り', flag: 'galoz_slain',
            lines: [
              'アルヴァ「……すまない。お前を 生かしておけば、民が 枕を高くして眠れない」',
    ...
    outro: ['ヴァルデリアの地に、平穏が戻った。築城は着実に進んでいく。'],
    outroIf: [
      { flag: 'galoz_spared', lines: ['「敵将を 生かした」という報せは、良くも悪くも 城下を ざわつかせた。'] },
      { flag: 'galoz_slain', lines: ['「敵将を 討った」という報せに 城下は沸いたが、アルヴァの表情は 晴れなかった。'] },
    ],
  },
  {
    title: '第六章 ― 魔法学院創設',
    ...
    stages: [
      {
        map: 'selmaria_town', type: 'gate',
        goal: '学院の者に 話を聞き、地下へ向かう',
        require: { talk: ['selmaria_vance', 'selmaria_librarian'] },
  ...
  {
    title: '第七章 ― 断崖の防人',
    intro: ['セレスティアは氏族の民を糾合し、断崖の上にシルヴァブルク城の基礎を築いた。並行して「業の底」の掃討作戦が始まる。'],
    stages: [
      {
        map: 'silvabruk_town', type: 'gate',
        goal: '防人たちから 海の異変を 聞く',
        require: { talk: ['silvabruk_knight', 'silvabruk_priestess'] },
  ...
  },
  {
    title: '第八章 ― アルヴァの盟約',
    intro: [
      '三国の基礎が固まったところで、アルヴァ・エルロード・セレスティアはヴァルデリアに集い、正式な建国と同盟の儀式を執り行う。',
      '「アルヴァの遺産」の分与が決定した――剣はヴァルデリア王家に、鎧はセルマリアの学院に、盾はシルヴァブルクの防人に。',
    ...
    stages: [{
      ...
      afterClear: {
        prompt: 'アルヴァの遺産――鎧と盾を、どこへ託すか。',
        options: [
          { label: '鎧を学院へ、盾を防人へ', note: '三国で 分け持つ', flag: 'legacy_split',
            lines: [
              'アルヴァ「鎧は セルマリアへ。守りの術式を 解き明かしてくれ」',
              'アルヴァ「盾は シルヴァブルクへ。最前線に 立つ者が 持つべきだ」',
              'エルロードとセレスティアは、静かに うなずいた。',
            ] },
          { label: '三つとも ヴァルデリアに納める', note: '力を 一箇所に集める', flag: 'legacy_kept',
            lines: [
              'アルヴァ「遺産は 分けぬ。散らせば、いずれ どれかが 失われる」',
              'エルロード「……それは、力を 一所に 集めるということですよ」',
              'アルヴァ「わかっている。だからこそ、見張る目が 要る」',
            ] },
        ],
      },
    }],
    ...
    outroIf: [
      { flag: 'legacy_split', lines: ['剣はヴァルデリアに、鎧はセルマリアに、盾はシルヴァブルクに。三つの国は、三つの遺産で 結ばれた。'] },
      { flag: 'legacy_kept', lines: ['三つの遺産は ヴァルデリアの宝物庫に並んだ。美しい眺めだったが、エルロードは 最後まで 何も言わなかった。'] },
    ],
    // アルヴァの遺産の分与。剣はヴァルデリア王家に、鎧は学院に、盾はシルヴァブルクの防人へ。
    onComplete: { gear: ['alva_sword', 'silver_armor', 'alva_shield'], gold: 500 },
  },
  {
    title: '第九章 ― 影の萌芽',
    intro: [
    ...
    stages: [{
      ...
      require: { talk: ['valderia_smith', 'valderia_noble', 'valderia_leyla'] },
      ...
      afterClear: {
        ...
        options: [
          { label: '疑いを 持って 見張る', note: '真相に 近づく', flag: 'barrows_suspected',
            lines: [
              'アルヴァ「あの男は 施しの量に対して、聞き出す量が 多すぎる」',
              'アルヴァは 密かに 見張りを付けるよう命じた。バロウズは そのことに 気づいた素振りすら 見せなかった。',
            ] },
          { label: '善意の聖職者として 迎える', note: '疑わずに 過ごす', flag: 'barrows_trusted',
            lines: [
              'アルヴァ「飢えた者に 施す手を 疑うのは、王のすることではない」',
  ...
  },
  {
    title: '第十章 ― 貴族の反乱',
    intro: [
      'ヴァルデリア国内で、旧来の武門貴族たちが「元竜帝軍出身の将バルガを重用するアルヴァの方針」に反発し、クーデターを画策した。',
      'アルヴァはバルガへの信を貫くと決め、その意志を示すように、バルガ自身が反乱鎮圧の先頭に立った。',
    ],
    stages: [{
      map: 'valderia_town', type: 'gate',
      goal: '貴族たちの言い分を 聞いて回る',
      require: { talk: ['valderia_noble', 'valderia_smith', 'valderia_leyla'] },
      blocked: 'まだ 言い分を 聞いていない者が いる。',
      afterClear: {
        prompt: '貴族たちは バルガの追放を求めている。',
        options: [
          { label: 'バルガへの信を 貫く', note: '将軍として 迎える', flag: 'balga_trusted',
            lines: [
              'アルヴァ「彼を 退けるということは、赦しによって国を建てるという 私の言葉を 退けることだ」',
              'バルガは 何も言わず、ただ 全軍の先頭に立った。反乱は 一日で 鎮まった。',
            ],
            result: { recruit: 'balga', gear: ['oathkeeper'], gold: 400 } },
          { label: '貴族の要求を 飲む', note: 'バルガは 去る', flag: 'balga_exiled',
            lines: [
              'アルヴァ「……すまない、バルガ」',
              'バルガ「よいのです。俺は 赦されるべき男では なかった」',
              '将軍は 一礼し、誰にも行き先を告げずに 城を出ていった。',
              '(バルガは 仲間にならない。以後も 三人で 旅を続けることになる)',
            ],
            result: { gold: 400 } },
        ],
      },
    ...
    outroIf: [
      { flag: 'balga_trusted', lines: ['バルガはアルヴァの最も忠実な右腕として、正式に一行へ加わった。'] },
      { flag: 'balga_exiled', lines: ['バルガの去った城は、以前より静かで、以前より少しだけ 冷たくなった。'] },
    ],
  },
  {
    title: '第十一章 ― 賢者の代償',
    ...
    stages: [
      {
        ...
        require: { talk: ['selmaria_librarian', 'selmaria_vance'] },
  ...
  },
  {
    ...
    stages: [{
      map: 'silvabruk_town', type: 'gate',
      goal: '後継者たちに 秘技を 伝える',
      require: { talk: ['silvabruk_celestia', 'silvabruk_knight', 'silvabruk_priestess'] },
      blocked: 'まだ 伝え終えていない者が いる。',
      // 三人に何を伝えるか。伝えたものが百年後のシルヴァブルクの形になる。
        ...
        },
        {
          ...
          options: [
            { label: '常在戦場の心得', note: '備えを絶やさぬ国に', flag: 'moon_taught_vigil',
              lines: [
                'セレスティア「眠るときも 剣を離すな。シルヴァブルクは 最も海に近い」',
    ...
    outroIf: [
      { flag: 'moon_taught_vigil',
        lines: ['シルヴァブルク王家は「常在戦場」を国是に据えた。以後 百年、この国の兵は 鎧を脱がなかった。'] },
      { flag: 'moon_taught_retreat',
        lines: ['シルヴァブルク王家は「民を先に」を国是に据えた。以後 百年、この国は 逃げ道を 絶やさなかった。'] },
  ...
  },
  {
    title: '第十三章 ― 百年の平穏',
    intro: [
      'アルヴァ、エルロード、セレスティアはそれぞれ年を重ね、王位を子へ、弟子へ、後継者へと譲っていく。',
      '三国は交易・婚姻・学問交流を重ね、大陸有数の繁栄を築いていった。',
    ],
    stages: [{
      map: 'tardome', type: 'gate',
      goal: '古都をめぐり、過ぎた歳月を 見届ける',
      require: { talk: ['tardome_king', 'tardome_oldwoman', 'tardome_soldier'] },
      ...
      afterClear: {
        ...
        options: [
          { label: '初代の死', note: '静かな幕引き', flag: 'era_death',
            lines: [
              'アルヴァは 玉座ではなく、東方街道の見える丘で 息を引き取った。',
  ...
  },
  {
    title: '終章 ― 竜の子らへ',
    intro: [
      '建国百年の式典が、盛大に執り行われた。ヴァルデリア、セルマリア、シルヴァブルクの王家三代目たちが一堂に会し、「アルヴァの盟約」を改めて誓い合う。',
      '式典の最後、アルヴァの子孫である若き王子が、宝物庫に眠るアルヴァの剣に静かに手を伸ばす。',
      '遠くシルヴァブルクの海の彼方に、まだ誰も気づいていない暗雲が浮かんでいた――。',
    ],
    stages: [{ map: 'valderia_town', type: 'gate', goal: '式典の広場へ 向かう' }],
    outro: ['式典は 滞りなく 終わった。'],
    ...
    outroIf: [
      ...
      { flag: 'legacy_kept', lines: ['遺産は すべてヴァルデリアの宝物庫にあった。他の二国の王は、それを 遠くから 眺めていた。'] },
      { flag: 'balga_trusted', lines: ['ヴァルデリア軍の旗には、いまも 折れた牙の意匠が 縫い込まれている。'] },
      { flag: 'balga_exiled', lines: ['ヴァルデリア軍の旗は 剣のみを描いている。折れた牙の意匠は、どこにも 残らなかった。'] },
      ...
      // 月の巫女が三人の弟子に伝えたものが、百年後のシルヴァブルクの形になっている
      { flag: 'moon_taught_vigil', lines: ['シルヴァブルクの衛士だけが、式典のあいだも 鎧を 着けたままだった。三代前の巫女の 言いつけである。'] },
      { flag: 'moon_taught_retreat', lines: ['シルヴァブルクの城には、他の二国にはない 逃げ道が 幾重にも 掘られている。三代前の巫女の 言いつけである。'] },
      { flag: 'moon_taught_reading', lines: ['シルヴァブルクの巫女だけが、式典のあいだ ときおり 空を 見上げていた。細くなっていく月を 数えるように。'] },
      { flag: 'moon_taught_healing', lines: ['シルヴァブルクの巫女は 式典に出ず、港の病者のもとに いたという。それもまた、三代前から 変わらない。'] },
      { lines: ['式典の最後、アルヴァの子孫である若き王子が、宝物庫に眠るアルヴァの剣に 静かに手を伸ばした。'] },
      { lines: ['― アルヴァの継承、完 ―'] },
      { lines: ['この物語は、百年後の「シルヴァブルク王国陥落」へと続いていく。'] },
    ],
  },
];

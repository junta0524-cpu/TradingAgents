...
Game.Data.Maps = {
  ...
  tardome: buildMap({
    id: 'tardome', name: 'タルドーム', kind: 'town', startX: 9, startY: 8,
    npcs: {
          '1': { id: 'tardome_soldier' },
          '2': { id: 'tardome_oldwoman' },
          'K': { id: 'tardome_king', king: true },
        },
    art: [
  ...
  valderia_town: buildMap({
    id: 'valderia_town', name: 'ヴァルデリア城下', kind: 'town', startX: 10, startY: 9,
    npcs: {
          '1': { id: 'valderia_leyla' },
          '2': { id: 'valderia_balga' },
          '3': { id: 'valderia_smith' },
  ...
  selmaria_town: buildMap({
    ...
    npcs: {
          '1': { id: 'selmaria_elrode' },
          '2': { id: 'selmaria_vance' },
          '3': { id: 'selmaria_librarian' },
        },
    art: [
      'YYYYYYYYYYYYYYYYYYYY',
      'YFFFFFFFFFFFFFFFFFFY',
  ...
  silvabruk_town: buildMap({
    id: 'silvabruk_town', name: 'シルヴァブルク', kind: 'town', startX: 9, startY: 6,
    npcs: {
          '1': { id: 'silvabruk_celestia' },
          '2': { id: 'silvabruk_knight' },
          '3': { id: 'silvabruk_priestess' },
        },
    art: [
      'YYYYYYYYYYYYYYYYYYYY',
  ...
  east_road: buildMap({
    ...
    encounterTable: 'east_road', church: 'タルドームの 教会',
    chests: { '1': 'medal_road' },
    art: [
      '########################',
      '#..###........####.....#',
  ...
  azure_plain: buildMap({
    ...
    encounterTable: 'azure_plain', church: 'タルドームの 教会',
  ...
  ogre_camp: buildMap({
    ...
    encounterTable: 'ogre_camp', church: 'ヴァルデリア城下の 教会', bossId: 'galoz',
  ...
  azure_tower: buildMap({
    ...
    encounterTable: 'azure_tower', church: 'タルドームの 教会', bossId: 'astro_guardian',
  ...
  academy_altar: buildMap({
    ...
    encounterTable: 'academy_altar', church: '学院都市セルマリアの 礼拝堂', bossId: 'magatsuki',
  ...
  abyss_depth: buildMap({
    ...
    encounterTable: 'abyss_depth', church: 'シルヴァブルクの 月の神殿', bossId: 'abyss_matriarch',
  ...
  forbidden_ritual_chamber: buildMap({
    ...
    encounterTable: 'forbidden_ritual_chamber', church: '学院都市セルマリアの 礼拝堂', bossId: 'genso_no_katsubo',

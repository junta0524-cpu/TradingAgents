...
// 杖の「INT補正」は、この作品では呪文の威力が atk から計算されるため atk として扱う。
...
Game.Data.Equipment = {
  ...
  // ---- 杖(エルロード)----
  wood_staff: { id: 'wood_staff', name: '木の杖', slot: 'weapon', kind: 'staff', atk: 5, price: 100 },
  silver_staff: { id: 'silver_staff', name: '銀の杖', slot: 'weapon', kind: 'staff', atk: 15, price: 600 },
  sage_staff: { id: 'sage_staff', name: '賢者の杖', slot: 'weapon', kind: 'staff', atk: 28, price: 1800 },
  azure_staff: { id: 'azure_staff', name: '蒼穹の杖', slot: 'weapon', kind: 'staff', atk: 45, price: 0, story: true },
  ...
  moon_bow: { id: 'moon_bow', name: '月の弓', slot: 'weapon', kind: 'bow', atk: 65, price: 0, story: true },

  // ---- よろい(全員)----
  cloth_robe: { id: 'cloth_robe', name: '布の服', slot: 'armor', kind: 'armor', def: 4, price: 80 },
  ...
  silver_armor: { id: 'silver_armor', name: '白銀の鎧', slot: 'armor', kind: 'armor', def: 42, price: 0, story: true },
  ...
  roto_shield: { id: 'roto_shield', name: 'ロトの盾', slot: 'shield', kind: 'shield', def: 32, price: 0, story: true },
  ...
  swift_necklace: { id: 'swift_necklace', name: '素早さの首飾り', slot: 'accessory', kind: 'accessory', spd: 10, price: 900 },
  spirit_earring: { id: 'spirit_earring', name: '精神の耳飾り', slot: 'accessory', kind: 'accessory', def: 6, price: 1100 },
  moonlight_brooch: { id: 'moonlight_brooch', name: '月光のブローチ', slot: 'accessory', kind: 'accessory', def: 8, price: 1400 },
  sage_glasses: { id: 'sage_glasses', name: '賢者のメガネ', slot: 'accessory', kind: 'accessory', atk: 5, def: 3, price: 1300 },
};
